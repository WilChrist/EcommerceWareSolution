...
namespace EcommerceWare.Models
{
    ...
    public partial class ecommerceEntities : DbContext
    {
        ...
        public virtual int InsertProduct(string name_Product, Nullable<int> idCategory, Nullable<int> idProducer, Nullable<int> idSupplier, Nullable<decimal> net_Price, Nullable<int> idTax_Level, string description_Product, Nullable<int> quantity_Possessed, Nullable<decimal> gross_Price)
        {
            var name_ProductParameter = name_Product != null ?
                new ObjectParameter("Name_Product", name_Product) :
                new ObjectParameter("Name_Product", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertProduct", name_ProductParameter, idCategoryParameter, idProducerParameter, idSupplierParameter, net_PriceParameter, idTax_LevelParameter, description_ProductParameter, quantity_PossessedParameter, gross_PriceParameter);
        }
        ...
        public virtual int UpdateProduct(string name_Product, Nullable<int> idCategory, Nullable<int> idProducer, Nullable<int> idSupplier, Nullable<decimal> net_Price, Nullable<int> idTax_Level, string description_Product, Nullable<int> quantity_Possessed, Nullable<decimal> gross_Price, Nullable<int> idProduct)
        {
            var name_ProductParameter = name_Product != null ?
                new ObjectParameter("Name_Product", name_Product) :
                new ObjectParameter("Name_Product", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateProduct", name_ProductParameter, idCategoryParameter, idProducerParameter, idSupplierParameter, net_PriceParameter, idTax_LevelParameter, description_ProductParameter, quantity_PossessedParameter, gross_PriceParameter, idProductParameter);
        }
